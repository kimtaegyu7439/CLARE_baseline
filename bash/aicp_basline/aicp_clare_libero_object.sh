...
source "$(dirname "${BASH_SOURCE[0]}")/aicp_env.sh";
...
python ./lerobot_lsy/src/lerobot/scripts/clare.py \
    ...
    --output_dir=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_0_encoder_mlp_adapter_threshold_1_0 \
...
python ./lerobot_lsy/src/lerobot/scripts/clare.py \
    ...
    --output_dir=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_1_encoder_mlp_adapter_threshold_1_0 \
    ...
    --save_freq=$STEPS \
    --log_freq=$LOG_STEPS \
    --peft_weight_path=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_0_encoder_mlp_adapter_threshold_1_0/checkpoints/last/adapter \
    --expand_threshold=1.0 \
    --detect_distribution_shift_steps=200 \
    --detect_distribution_shift_batch_size=32 \
    --detect_distribution_shift_num_workers=16 \
...
python ./lerobot_lsy/src/lerobot/scripts/clare.py \
    ...
    --output_dir=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_2_encoder_mlp_adapter_threshold_1_0 \
    ...
    --save_freq=$STEPS \
    --log_freq=$LOG_STEPS \
    --peft_weight_path=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_1_encoder_mlp_adapter_threshold_1_0/checkpoints/last/adapter \
    --expand_threshold=1.0 \
    --detect_distribution_shift_steps=200 \
    --detect_distribution_shift_batch_size=32 \
    --detect_distribution_shift_num_workers=16 \
...
python ./lerobot_lsy/src/lerobot/scripts/clare.py \
    ...
    --output_dir=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_3_encoder_mlp_adapter_threshold_1_0 \
    ...
    --save_freq=$STEPS \
    --log_freq=$LOG_STEPS \
    --peft_weight_path=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_2_encoder_mlp_adapter_threshold_1_0/checkpoints/last/adapter \
    --expand_threshold=1.0 \
    --detect_distribution_shift_steps=200 \
    --detect_distribution_shift_batch_size=32 \
    --detect_distribution_shift_num_workers=16 \
...
python ./lerobot_lsy/src/lerobot/scripts/clare.py \
    ...
    --output_dir=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_4_encoder_mlp_adapter_threshold_1_0 \
    ...
    --save_freq=$STEPS \
    --log_freq=$LOG_STEPS \
    --peft_weight_path=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_3_encoder_mlp_adapter_threshold_1_0/checkpoints/last/adapter \
    --expand_threshold=1.0 \
    --detect_distribution_shift_steps=200 \
    --detect_distribution_shift_batch_size=32 \
    --detect_distribution_shift_num_workers=16 \
...
python ./lerobot_lsy/src/lerobot/scripts/clare.py \
    ...
    --output_dir=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_5_encoder_mlp_adapter_threshold_1_0 \
    ...
    --save_freq=$STEPS \
    --log_freq=$LOG_STEPS \
    --peft_weight_path=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_4_encoder_mlp_adapter_threshold_1_0/checkpoints/last/adapter \
    --expand_threshold=1.0 \
    --detect_distribution_shift_steps=200 \
    --detect_distribution_shift_batch_size=32 \
    --detect_distribution_shift_num_workers=16 \
...
python ./lerobot_lsy/src/lerobot/scripts/clare.py \
    ...
    --output_dir=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_6_encoder_mlp_adapter_threshold_1_0 \
    ...
    --save_freq=$STEPS \
    --log_freq=$LOG_STEPS \
    --peft_weight_path=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_5_encoder_mlp_adapter_threshold_1_0/checkpoints/last/adapter \
    --expand_threshold=1.0 \
    --detect_distribution_shift_steps=200 \
    --detect_distribution_shift_batch_size=32 \
    --detect_distribution_shift_num_workers=16 \
...
python ./lerobot_lsy/src/lerobot/scripts/clare.py \
    ...
    --output_dir=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_7_encoder_mlp_adapter_threshold_1_0 \
    ...
    --save_freq=$STEPS \
    --log_freq=$LOG_STEPS \
    --peft_weight_path=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_6_encoder_mlp_adapter_threshold_1_0/checkpoints/last/adapter \
    --expand_threshold=1.0 \
    --detect_distribution_shift_steps=200 \
    --detect_distribution_shift_batch_size=32 \
    --detect_distribution_shift_num_workers=16 \
...
python ./lerobot_lsy/src/lerobot/scripts/clare.py \
    ...
    --output_dir=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_8_encoder_mlp_adapter_threshold_1_0 \
    ...
    --save_freq=$STEPS \
    --log_freq=$LOG_STEPS \
    --peft_weight_path=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_7_encoder_mlp_adapter_threshold_1_0/checkpoints/last/adapter \
    --expand_threshold=1.0 \
    --detect_distribution_shift_steps=200 \
    --detect_distribution_shift_batch_size=32 \
    --detect_distribution_shift_num_workers=16 \
...
python ./lerobot_lsy/src/lerobot/scripts/clare.py \
    ...
    --output_dir=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_9_encoder_mlp_adapter_threshold_1_0 \
    ...
    --save_freq=$STEPS \
    --log_freq=$LOG_STEPS \
    --peft_weight_path=./outputs/aicp/libero_object/clare/dit_flow_mt_cl_seed_${SEED}_libero_object_task_8_encoder_mlp_adapter_threshold_1_0/checkpoints/last/adapter \
    --expand_threshold=1.0 \
    --detect_distribution_shift_steps=200 \
    --detect_distribution_shift_batch_size=32 \
    --detect_distribution_shift_num_workers=16 \
