#!/usr/bin/env bash
#
# CLARE 평가 결과(outputs/CLARE_eval/<bench>/seed<N>/stage*/task*/eval_info.json)를
# SR 행렬 txt로 모은다. ER 쪽 bash/er/collect_er_sr.sh 와 같은 형식이다.
#
...
#
# 사용법
#   bash bash/clare/collect_clare_sr.sh                       # 넷 다 (있는 것만)
#   bash bash/clare/collect_clare_sr.sh libero_object         # 하나만
#
...
SEED=${SEED:-42}
EVAL_ROOT=${EVAL_ROOT:-./outputs/CLARE_eval}
PYTHON=${PYTHON:-python3}

BENCHES=${*:-${BENCH:-"libero_10 libero_goal libero_spatial libero_object libero_40"}}
